    ...
    namespace network
    {
        class Socket : public core::CerberusObject
        {
           private:
            ...
            OpRes TLS_send(const data::ByteBuffer& buffer);

            OpRes TLS_sendFile(const data::filesystem::File& file);

            OpRes TLS_recv(data::ByteBuffer& buffer);
           ...
           public:
            ...
            OpRes recv(data::ByteBuffer& buffer, const time::TimeFrame& timeout, const time::TimeFrame& cycTimeout = time::TimeFrame());
            ...
            OpRes TLS_init(const std::string& certfile = "", const std::string& keyfile = "", bool forceServer = false);
            ...
            OpRes recv(data::filesystem::File& file, const time::TimeFrame& timeout = time::TimeFrame(), const time::TimeFrame& cycTimeout = time::TimeFrame());
        };
    }  // namespace network
}  // namespace cerberus
