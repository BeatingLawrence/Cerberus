...
#define logInfo(text, ...)                                                              \
    ::cerberus::Cerberus::log(::cerberus::CerberusUtils::strPrint(text, ##__VA_ARGS__), \
                              ::cerberus::LogLevel::LL_Info, "CERB", false)
#define logWarning(text, ...)                                                           \
    ::cerberus::Cerberus::log(::cerberus::CerberusUtils::strPrint(text, ##__VA_ARGS__), \
                              ::cerberus::LogLevel::LL_Warning, "CERB", false)
#define logError(text, ...)                                                             \
    ::cerberus::Cerberus::log(::cerberus::CerberusUtils::strPrint(text, ##__VA_ARGS__), \
                              ::cerberus::LogLevel::LL_Error, "CERB", false)
#define logDebug(text, ...)                                                             \
    ::cerberus::Cerberus::log(::cerberus::CerberusUtils::strPrint(text, ##__VA_ARGS__), \
                              ::cerberus::LogLevel::LL_Debug, "CERB", false)
...
#define thrlogWarning(text) \
    ::cerberus::Cerberus::log(text, ::cerberus::LogLevel::LL_Warning, this->name(), true)
